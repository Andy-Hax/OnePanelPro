								...
								<div class="card-body">
									<form action="action.php" method="post" role="form">
										<div class="input-group input-group-outline mb-3 is-filled">
											...
											<input name="id" type="hidden" value="<?php echo $dnsEditInfo['id'] ?>" />
											<input name="name" type="text" class="form-control" value="<?php echo $dnsEditInfo['name'] ?>">
										</div>
										<div class="input-group input-group-outline mb-3 is-filled">
											<label class="form-label">DNS</label>
											<input name="portal" type="text" class="form-control" value="<?php echo $dnsEditInfo['portal'] ?>">
										</div>
										...
										<div class="text-center">
											<button name="updatedns" type="submit" class="btn btn-lg bg-gradient-secondary btn-lg w-100 mt-4 mb-0">Update</button>
										</div>
									</form>
								</div>
