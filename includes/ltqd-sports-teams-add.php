								...
								<div class="card-body">
									<form action="action.php" method="post" role="form">
										...
										<div class="input-group input-group-outline mb-3">
											...
											<input name="flag" type="text" class="form-control" value="">
										</div>
										<div class="text-center">
											<button name="addltqdsportsteams" type="submit" class="btn btn-lg bg-gradient-secondary btn-lg w-100 mt-4 mb-0">Add</button>
										</div>
									</form>
								</div>
							</div>
