			...
			<div class="card-header pb-0">
				<div class="row">
					<div class="col-lg-6 col-7">
						<h6>Add LTQD Sports Category</h6>
					</div>
				</div>
			</div>
								...
								<div class="card-body">
									<form action="action.php" method="post" role="form">
										...
										<div class="text-center">
											<button name="addltqdsportscategories" type="submit" class="btn btn-lg bg-gradient-secondary btn-lg w-100 mt-4 mb-0">Add</button>
										</div>
									</form>
								</div>
							</div>
