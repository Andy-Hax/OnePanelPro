			...
			<div class="card-header pb-0">
				<div class="row">
					...
					<div class="col-6 text-end">
						<a href="dashboard.php?ltqd-themes-add">
								...
								<div class="card-body">
									<div class="table-responsive p-0">
										<table class="table align-items-center justify-content-center mb-0">
											...
											<tbody>
												<?php
												foreach ($ltqdThemesInfo as $thisTheme) {
												?>
													<tr>
														<td>
															<div class="d-flex px-2">
																<div class="my-auto">
																	<h6 class="mb-0 text-sm"><?php echo $thisTheme['name']; ?></h6>
																</div>
															</div>
														</td>
														<td>
															<div class="d-flex px-2">
																<div class="my-auto">
																	<img src="<?php echo $thisTheme['preview_image']; ?>" style="max-width:500px;"/>
																</div>
															</div>
														</td>
														<td class="align-right">
															<a href="dashboard.php?ltqd-themes-edit&id=<?php echo $thisTheme['id']; ?>">
																<button title="Edit" class="btn btn-link text-secondary mb-0">
																	<i class="fa fa-ellipsis-v text-xs"></i>
																</button>
															</a>
															<a onclick="return confirm('Are you sure?');" href="action.php?ltqd-themes-delete&id=<?php echo $thisTheme['id']; ?>">
