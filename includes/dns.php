										...
										<table class="table align-items-center justify-content-center mb-0">
											<thead>
												<tr>
													...
													<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">DNS</th>
													...
													<tr>
														<td>
															<div class="d-flex px-2">
																<div class="my-auto">
																	<h6 class="mb-0 text-sm"><?php echo $thisDns['name']; ?></h6>
																</div>
															</div>
														</td>
														<td>
															<div class="d-flex px-2">
																<div class="my-auto">
																	<h6 class="mb-0 text-sm"><?php echo $thisDns['portal']; ?></h6>
																</div>
															</div>
														</td>
														<?php
														...
														<td class="align-right">
															<a href="dashboard.php?dns-edit&id=<?php echo $thisDns['id']; ?>">
																<button title="Edit" class="btn btn-link text-secondary mb-0">
																	<i class="fa fa-ellipsis-v text-xs"></i>
																</button>
															</a>
															<a onclick="return confirm('Are you sure?');" href="action.php?dns-delete&id=<?php echo $thisDns['id']; ?>">
