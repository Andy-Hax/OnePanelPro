			...
			<div class="card-header pb-0">
				<div class="row">
					<div class="col-lg-6 col-7">
						<h6>LTQD Sports Teams</h6>
					</div>
					<div class="col-6 text-end">
						<a href="dashboard.php?ltqd-sports-teams-add">
													...
													<tr>
														<td>
															<div class="d-flex px-2">
																<div class="my-auto">
																	<h6 class="mb-0 text-sm"><?php echo $thisTeam['name']; ?></h6>
																</div>
															</div>
														</td>
														<td>
															<div class="d-flex px-2">
																<div class="my-auto">
																	<img src="<?php echo $thisTeam['flag']; ?>" style="max-width:50px;"/>
																</div>
															</div>
														</td>
														<td class="align-right">
															<a href="dashboard.php?ltqd-sports-teams-edit&id=<?php echo $thisTeam['id']; ?>">
																<button title="Edit" class="btn btn-link text-secondary mb-0">
																	<i class="fa fa-ellipsis-v text-xs"></i>
																</button>
															</a>
															<a onclick="return confirm('Are you sure?');" href="action.php?ltqd-sports-teams-delete&id=<?php echo $thisTeam['id']; ?>">
